...
export default function Route() {
  ...
  const initialDays = useMemo(() => {
    const source = import.meta.env.DEV ? DEV_DAY_ROUTES : [];
    return source.map((day) => {
      const originalPois = clonePois(day.pois);
      const pois = clonePois(day.pois);
          ...
          <section className={styles.daysSection}>
            <div className={styles.daysHeader}>
              ...
              <p className={styles.sectionSubtle}>
                Switch between calculated daily routes
              </p>
            </div>
              ...
              <div className={styles.cardHeader}>
                <div>
                  <h3 className={styles.cardTitle}>
                    Day {activeDayIndex + 1} Plan
                  </h3>
                  <p className={styles.cardSubtle}>
                    Add, delete or reorder POIs for this day
                  </p>
                </div>
